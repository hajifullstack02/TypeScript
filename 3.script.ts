...
var employeeDetails :[number , string ,number , boolean] = [1, "Haji" , 24 , false];
...
var employeeDetails_2 : [any , any , boolean] = [ 8142, "bahadur" , true ] ;
console.log(employeeDetails_2[0]);  // 8142
console.log(employeeDetails_2[1]);  //bahadur
console.log(employeeDetails_2[2]);  //true


var employeeDetails_3 : [string , string , boolean] = [  "helo" , "world" , true ] ;
...
// for object 
var cusomer_deails : {cusname:string,age:number,loc:string} = { cusname: "john", age: 30 , loc:"bengolore" };
console.log(cusomer_deails.cusname); //john
console.log(cusomer_deails.age); //30
console.log(cusomer_deails.loc); //"bengoroe"


var obj:{studentId:number} = {
    studentId : 101
}

//this is best practice
var obj1:{studentId:number}  = {
    "studentId" : 102
}

var obj2:{studentId:number , location:string}  = {
    "studentId" : 103,
    "location"  : "Hyd"
}
...
var obj3:{studentId:number , location?:string}  = {
    "studentId" : 1,
    "location"  : "mumboi"
}