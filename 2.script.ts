...
//arrays
var student_names: string[] =["haji","naveen","raj"]
student_names.push("naresh");
console.log(student_names);

var student_ages:number[]=[23,24,25]
student_ages.push(21);
console.log(student_ages);

var student_clg:readonly string[]=["haji","bahadur"]
